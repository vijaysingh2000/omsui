...
export class BatchInvoiceService {
  ...
  getList(request: BatchInvoice_Request): Observable<BatchInvoice[]> {
    return this.http.post<BatchInvoice[]>(`${BASE_URL}/api/BatchInvoice/GetList`, request);
  }

  doesBatchNameExists(request: BatchInvoice_Request): Observable<boolean> {
    return this.http.post<boolean>(`${BASE_URL}/api/BatchInvoice/DoesBatchNameExists`, request);
  }
  ...
  updateBatchInvoices(request: BatchInvoice_Request): Observable<BatchInvoice[]> {
    return this.http.post<BatchInvoice[]>(`${BASE_URL}/api/BatchInvoice/UpdateBatchInvoices`, request);
  }

  addOrUpdate(request: BatchInvoice_Request): Observable<BatchInvoice> {
    return this.http.post<BatchInvoice>(`${BASE_URL}/api/BatchInvoice/AddOrUpdate`, request);
  }
}
